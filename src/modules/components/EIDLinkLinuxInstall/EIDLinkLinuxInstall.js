    ...
    return (
        <div>
            <div className="col">
                ...
                <NumberdText number={"1"}><FormattedMessage id="beidconnect.linux.step.1" defaultMessage={'Install the \'eID-archive\' so the "eID" pakket repository becomes available'}/></NumberdText>
