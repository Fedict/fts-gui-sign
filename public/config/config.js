window.configData = {
    ...
    //CSP: "default-src 'self'; connect-src self' blob: https://*.ta.fts.bosa.belgium.be;  script-src 'self' 'unsafe-inline'; style-src 'unsafe-inline'; object-src 'self' blob: data: https://*.ta.fts.bosa.belgium.be;" ,
