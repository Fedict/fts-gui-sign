window.configData = {
    ...
    CSP: "default-src 'self'; connect-src 'self' https://validate.ta.fts.bosa.belgium.be   https://mintest.ta.fts.bosa.belgium.be;  script-src 'self' 'unsafe-inline'; style-src 'unsafe-inline'; object-src 'self' blob: data: https://validate.ta.fts.bosa.belgium.be;  frame-src 'self' blob: data: https://validate.ta.fts.bosa.belgium.be;" ,
